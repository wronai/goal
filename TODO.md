...
**Generated on:** 2026-03-27T17:52:28.627796
**Total issues:** 225 active, 98 completed
...
- [x] goal/changelog.py:9 - Function 'update_changelog' missing return type (suggested: -> None)
- [x] goal/changelog.py:6 - Unused Optional imported from typing
- [x] goal/changelog.py:6 - Unused import: 'Optional'
- [x] goal/changelog.py:76 - Cannot use an escape sequence (backslash) in f-strings on Python 3.8 (syntax was added in Python 3.12)
- [x] goal/changelog.py:9 - LLM-style docstring in update_changelog
- [x] goal/cli/__init__.py:139 - String concatenation can be converted to f-string
- [x] goal/cli/__init__.py:100 - String concatenation can be converted to f-string
...
- [x] goal/cli/doctor_cmd.py:24 - String concatenation can be converted to f-string
- [x] goal/cli/doctor_cmd.py:54 - String concatenation can be converted to f-string
- [x] goal/cli/version.py:192 - String concatenation can be converted to f-string
- [x] goal/cli/version.py:422 - String concatenation can be converted to f-string
- [x] goal/cli/version.py:443 - String concatenation can be converted to f-string
- [x] goal/cli/version.py:8 - Unused run_git imported from goal.git_ops
- [x] goal/cli/version.py:8 - Unused import: 'run_git'
- [x] goal/cli/version.py:403 - boilerplate copyright
- [x] goal/cli/version.py:404 - boilerplate copyright
- [x] goal/cli/version.py:417 - boilerplate copyright
- [x] goal/config/validation.py:369 - String concatenation can be converted to f-string
- [x] goal/config/validation.py:377 - String concatenation can be converted to f-string
- [x] goal/config/validation.py:412 - Duplicate import: 'GoalConfig' (first at line 364)
- [x] goal/config/validation.py:20 - Cannot use an escape sequence (backslash) in f-strings on Python 3.8 (syntax was added in Python 3.12)
- [x] goal/config/validation.py:22 - Cannot use an escape sequence (backslash) in f-strings on Python 3.8 (syntax was added in Python 3.12)
- [x] goal/config/validation.py:354 - LLM-style docstring in validate_config_file
- [x] goal/config/validation.py:403 - LLM-style docstring in validate_config_interactive
- [x] goal/config/validation.py:453 - LLM-style docstring in _auto_fix_config
- [x] goal/deep_analyzer.py:107 - String concatenation can be converted to f-string
- [x] goal/doctor/dotnet.py:12 - String concatenation can be converted to f-string
- [x] goal/doctor/python.py:61 - String concatenation can be converted to f-string
- [x] goal/doctor/python.py:76 - Cannot reuse outer quote character in f-strings on Python 3.8 (syntax was added in Python 3.12)
- [x] goal/doctor/todo.py:104 - String concatenation can be converted to f-string
- [x] goal/doctor/todo.py:97 - Cannot use an escape sequence (backslash) in f-strings on Python 3.8 (syntax was added in Python 3.12)
- [x] goal/doctor/todo.py:15 - Magic number: 50 - use named constant
- [x] goal/doctor/todo.py:54 - LLM-style docstring in add_issues_to_todo
- [x] goal/generator/analyzer.py:200 - String concatenation can be converted to f-string
- [x] goal/generator/generator.py:252 - String concatenation can be converted to f-string
...
- [x] goal/git_ops.py:514 - Magic number: 10000 - use named constant
- [x] goal/git_ops.py:241 - LLM-style docstring in clone_repository
- [x] goal/push/core.py:28 - String concatenation can be converted to f-string
- [x] goal/push/core.py:99 - String concatenation can be converted to f-string
- [x] goal/push/core.py:5 - Unused Path imported from pathlib
- [x] goal/push/core.py:5 - Unused import: 'Path'
- [x] goal/push/core.py:159 - Duplicate import: 'format_push_result' (first at line 67)
- [x] goal/push/stages/version.py:38 - String concatenation can be converted to f-string
- [x] goal/push/stages/version.py:4 - Unused Any imported from typing
- [x] goal/push/stages/version.py:4 - Unused import: 'Any'
- [x] goal/recovery/manager.py:65 - String concatenation can be converted to f-string
- [x] goal/recovery/manager.py:7 - Unused Tuple imported from typing
- [x] goal/recovery/manager.py:19 - Unused RecoveryError imported from exceptions
- [x] goal/recovery/manager.py:19 - Unused RollbackError imported from exceptions
- [x] goal/recovery/strategies.py:43 - String concatenation can be converted to f-string
- [x] goal/recovery/strategies.py:8 - Unused Optional imported from typing
- [x] goal/recovery/strategies.py:11 - Unused RecoveryError imported from exceptions
- [x] goal/recovery/strategies.py:11 - Unused AuthError imported from exceptions
- [x] goal/recovery/strategies.py:336 - Magic number: 50 - use named constant
- [x] goal/smart_commit/abstraction.py:148 - String concatenation can be converted to f-string
- [x] goal/smart_commit/generator.py:116 - String concatenation can be converted to f-string
- [x] goal/summary/generator.py:301 - String concatenation can be converted to f-string
- [x] goal/summary/generator.py:438 - String concatenation can be converted to f-string
- [x] goal/summary/generator.py:304 - String concatenation can be converted to f-string
...
- [x] goal/summary/generator.py:478 - LLM-style docstring in _format_changes_section
- [x] goal/summary/quality_filter.py:230 - String concatenation can be converted to f-string
- [x] goal/summary/quality_filter.py:265 - String concatenation can be converted to f-string
- [x] goal/summary/quality_filter.py:82 - Magic number: 200 - use named constant
- [x] goal/summary/quality_filter.py:158 - Magic number in comparison: 50
- [x] goal/summary/quality_filter.py:245 - Magic number in comparison: 250
- [x] goal/summary/quality_filter.py:141 - LLM-style docstring in format_complexity_delta
- [x] goal/summary/quality_filter.py:224 - LLM-style docstring in format_net_lines
- [x] goal/validation/rules.py:163 - String concatenation can be converted to f-string
- [x] goal/validation/rules.py:17 - LLM-style docstring in validate
- [x] goal/validators/file_validator.py:140 - String concatenation can be converted to f-string
- [x] goal/validators/file_validator.py:211 - String concatenation can be converted to f-string
- [x] goal/validators/file_validator.py:198 - String concatenation can be converted to f-string
- [x] goal/validators/file_validator.py:257 - Duplicate import: 'run_git' (first at line 412)
- [x] goal/validators/file_validator.py:62 - LLM-style docstring in detect_tokens_in_content
- [x] goal/validators/file_validator.py:148 - LLM-style docstring in check_dot_folders
- [x] goal/validators/file_validator.py:217 - LLM-style docstring in manage_dot_folders
- [x] test_recovery.py:117 - String concatenation can be converted to f-string
- [x] test_recovery.py:103 - standalone main function
- [x] test_recovery.py:126 - module execution block
